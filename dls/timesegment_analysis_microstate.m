clc;clear;
baseDir = 'E:\SEED\microstate\20s\14_20140615\';
subDirs = {'1','2','3','4','5'};
prefixes = {'14_20140615Data1_', '14_20140615Data6_', '14_20140615Data9_', '14_20140615Data10_', '14_20140615Data14_'};
for s = 1:length(subDirs)
    ...
    xlswrite('E:\SEED\microstate\分开导入\第二次实验\14.xlsx', features_data, strcat('Sheet', num2str(s)), 'B1');
end